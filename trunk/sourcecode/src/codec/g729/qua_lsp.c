...
void Qua_lsp( Word16 lsp[],       /* (i) Q15 : Unquantized LSP            */
...
void Lsp_qua_cs( Word16 flsp_in[ M],    /* (i) Q13 : Original LSP parameters    */
...
void Relspwed( Word16                  lsp[],                     /* (i) Q13 : unquantized LSP parameters */
...
void Lsp_pre_select( Word16          rbuf[],              /* (i) Q13 : target vetor             */
                     Word16 lspcb1[][M],      /* (i) Q13 : first stage LSP codebook */
...
void Lsp_select_1( Word16          rbuf[],              /* (i) Q13 : target vector             */
...
void Lsp_select_2( Word16          rbuf[],              /* (i) Q13 : target vector             */
                   Word16          lspcb1[],            /* (i) Q13 : first stage lsp codebook  */
...
void Lsp_get_tdist( Word16  wegt[],        /* (i) norm: weight coef.                */
...
void Lsp_last_select( Word32  L_tdist[],     /* (i) Q27 : distortion         */
...
void Get_wegt( Word16 flsp[],    /* (i) Q13 : M LSP parameters  */
