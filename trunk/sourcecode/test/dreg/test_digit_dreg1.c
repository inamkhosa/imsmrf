...
int main( int nArgc_i, char* ppcArgv_i[] )
{
	...
	else                // Multiple Command Line Arguments Found
	{
		...
		printf( "\tAccepted Syntax for Execution : ./test_digit_dreg1" );
		return (-1);
	}
	...
	strcpy( oDRegExConfig.pcExpression, "7" );
	...
	printf( "Given Character for Matching : 7\n" );
	eRet_Code = re_match( hDRegEx1, '7' );
