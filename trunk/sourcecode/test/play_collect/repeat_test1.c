...
char RT1_XFile[] = "<?xml version=\"1.0\"?>\
        ...
        delay=\"500\" duration=\"infinite\" repeat=\"0\">\
        <audio url=\"file.wav\" encoding=\"ulaw\"/>\
...
void UT_Test_Mscml_Play_MSCML_PLAY_RES_Handler( void* pvMSContext_i, void* pvParseXMLPContext_i, void* pvEventHandle_i, void* pvEventPayload_i )
{
	...
	{
		MS_TRACE( g_nMscmlPlayTraceID, AMPS_TRACE_LEVEL_INFO, "SUCCESS: UNIT TEST MSCML_RESPONSE\n:" );
	}
	else
	{
		MS_TRACE( g_nMscmlPlayTraceID, AMPS_TRACE_LEVEL_INFO, "UNIT TEST FAILED\n:" );
	}
...
void UT_Player_PLAYER_REQ_Handler( void* pvMSContext_i, void* pvParseXMLContext_i, void* pvEventHandle_i, void* pvEventPayload_i )
{
	...
	switch( poPlayerInputEvent->eType )
	{
		case START_PLAY:
			...
			MS_TRACE( g_nMscmlPlayTraceID, AMPS_TRACE_LEVEL_INFO, "START_PLAYSTART_PLAYSTART_PLAYSTART_PLAYSTART_PLAYSTART_PLAY.\n" );
