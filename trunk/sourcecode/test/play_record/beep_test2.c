...
enum e_BeepTest2States
{
	Beep2_W4Start_Recording,
	Beep2_W4Mscml_Response
};
enum e_BeepTest2States eRT1CurrentState;
...
int execute_test( void* pvMSContext_i )
{
	...
	eRT1CurrentState = Beep2_W4Start_Recording;
...
void UT_Test_Mscml_Play_MSCML_PLAY_RES_Handler( void* pvMSContext_i, void* pvParseXMLPContext_i, void* pvEventHandle_i, void* pvEventPayload_i )
{
	...
	if( eRT1CurrentState == Beep2_W4Mscml_Response && poPSMOutputEvent->eType == MSCML_RESPONSE )
	{
...
void UT_Player_PLAYER_REQ_Handler( void* pvMSContext_i, void* pvParseXMLContext_i, void* pvEventHandle_i, void* pvEventPayload_i )
{
	...
	switch( poPlayerInputEvent->eType )
	{
		...
		case STOP_RECORDING:
			if( eRT1CurrentState == Beep2_W4Start_Recording )
			{
				eRT1CurrentState = Beep2_W4Mscml_Response;
			}
			else
			{
