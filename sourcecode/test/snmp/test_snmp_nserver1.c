...
**
*******************************************************************************
** FILE NAME        : test_snmp_nserver1.c
...
int SNMP_NotifyCallBack( AMPS_HANDLE r_hAMPS_HANDLE_i, void* r_pvData_i )
{
	...
	strcpy( oSnmpTrapMsg.pcOid, "announceSessionAttemptConf" );
	strcpy( oSnmpTrapMsg.pcValue, "-1" );
	strcpy( oSnmpTrapMsg.pcSeverity, "low" );
	oSnmpTrapMsg.nErrorCode = 400;
	strcpy( oSnmpTrapMsg.pcErrorDesc, "Bad Request" );
