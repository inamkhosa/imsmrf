...
char RT1_XFile[] = "<?xml version=\"1.0\"?>\
        ...
        recencoding=\"msgsm\"\
        initsilence=\"100\" endsilence=\"100\" duration=\"1000\"\
        barge=\"yes\"\
        beep=\"no\"\
        mode=\"overwrite\"\
        cleardigits=\"no\"\
...
void UT_Test_Mscml_Play_MSCML_PLAY_RES_Handler( void* pvMSContext_i, void* pvParseXMLPContext_i, void* pvEventHandle_i, void* pvEventPayload_i )
{
	...
	{
		MS_TRACE( g_nMscmlPlayTraceID, AMPS_TRACE_LEVEL_ERROR, "SUCCESS: DTMFKEY UNIT TEST MSCML_RESPONSE\n:" );
	}
	else
	{
...
//     if( eRT1CurrentState == DTMFKT1_W4Mscml_Response )
//     {
