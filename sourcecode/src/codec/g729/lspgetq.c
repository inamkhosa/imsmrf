...
void Lsp_get_quant( Word16 lspcb1[][   M],      /* (i) Q13 : first stage LSP codebook      */
...
*/
void Lsp_prev_compose( Word16             lsp_ele[],             /* (i) Q13 : LSP vectors                 */
...
*/
void Lsp_prev_extract( Word16 lsp[             M],                 /* (i) Q13 : unquantized LSP parameters  */
...
*/
void Lsp_prev_update( Word16 lsp_ele[         M],             /* (i)   Q13 : LSP vectors           */
