...
*******************************************************************************
** $Id: AMPS_Defines.h,v 1.50 2009/02/20 10:05:11 zaka Exp $
...
//ERROR Code
#define AMPS_DNS_NO_RR_FOUND                         -14



#define AMPS_ERROR_SOCKET_CLOSED				-13
#define AMPS_ERROR_HANDLE_EOF					-12
#define AMPS_ERROR_IO_PENDING					-11
#define AMPS_INVALID_TRACE_ID					-2
#define AMPS_ERROR_FAILURE						-1
#define AMPS_SUCCESS				 			0
#define AMPS_ADDRESS_NATTED			 			1
#define AMPS_ADDRESS_NOT_NATTED			 		2
#define AMPS_STATUS_PENDING			 			3

#define AMPS_INVALID_HANDLE              		0

#define AMPS_CONNECT_PENDING					2
#define AMPS_SEND_MSG_PENDING					3
#define AMPS_CONNECTION_HANGUP					4

#define AMPS_MSG_AWAITING						11
#define AMPS_MSG_PENDING						12
#define AMPS_MSG_COMPLETED						13

#define AMPS_CONNECTION_TYPE_TCP				5
#define AMPS_CONNECTION_TYPE_UDP				6
#define AMPS_CONNECTION_TYPE_SCTP				7
#define AMPS_CONNECTION_TYPE_FIFO				10
#define AMPS_CONNECTION_TYPE_PIPE				11
#define AMPS_CONNECTION_TYPE_STCP				30
//#define AMPS_CONNECTION_TYPE_SUDP				31
...
#define AMPS_LLIST_KEYS_ARE_EQUAL				0
#define AMPS_LLIST_KEY_IS_GREATER				1
#define AMPS_LLIST_KEY_IS_SMALLER				2

#define AMPS_LLIST_KEYS_CANNOT_BE_COMPARED		4


#define AMPS_HASH_TABLE_KEY_SIZE				1009

#define AMPS_TRACE_MODE_DISPLAY     			1
#define AMPS_TRACE_MODE_FILE        			2
#define AMPS_TRACE_MODE_BOTH        			3

#define AMPS_TRACE_LEVEL_ERROR          		1
#define AMPS_TRACE_LEVEL_WARNING    			2
#define AMPS_TRACE_LEVEL_DEBUG          		4
#define AMPS_TRACE_LEVEL_DEBUG_2				8
#define AMPS_TRACE_LEVEL_INFO      				16
