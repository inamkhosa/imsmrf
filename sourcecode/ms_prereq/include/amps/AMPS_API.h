...
*******************************************************************************
** $Id: AMPS_API.h,v 1.67 2009/02/24 10:57:58 zaka Exp $
...
/*
AMPS_API void AMPS_EncryptString(void* r_pvAMPSContext, char* r_pchInputBuff, int nInputBuffLen, char* r_pchKey, int r_nKeyLen, char* r_pchOutputBuff, int* r_pnOutputBuffLen);
AMPS_API void AMPS_DecryptString(void* r_pvAMPSContext, char* r_pchInputBuff, int nInputBuffLen, char* r_pchKey, int r_nKeyLen, char* r_pchOutputBuff, int* r_pnOutputBuffLen);
*/
...
AMPS_API AMPS_DBES_HANDLE AMPS_DBEngineStatementInit(AMPS_HANDLE r_hAMPS_HANDLE, AMPS_DBE_HANDLE r_phAMPS_DBE_HANDLE);
AMPS_API int AMPS_DBEngineStatementPrepare(AMPS_HANDLE r_hAMPS_HANDLE, AMPS_DBE_HANDLE r_phAMPS_DBE_HANDLE, AMPS_DBES_HANDLE r_hAMPS_DBES_HANDLE, const char* r_puchQuery, int r_nQueryLength);
AMPS_API int AMPS_DBEngineStatementParamCount(AMPS_HANDLE r_hAMPS_HANDLE, AMPS_DBE_HANDLE r_phAMPS_DBE_HANDLE, AMPS_DBES_HANDLE r_hAMPS_DBES_HANDLE);
AMPS_API void* AMPS_DBEngineCreateBindParameters(AMPS_HANDLE r_hAMPS_HANDLE, AMPS_DBE_HANDLE r_phAMPS_DBE_HANDLE, int r_nNumberOfBindings);
AMPS_API void AMPS_DBEngineSetBindingParameter(AMPS_HANDLE r_hAMPS_HANDLE, AMPS_DBE_HANDLE r_phAMPS_DBE_HANDLE, AMPS_DBES_HANDLE r_hAMPS_DBES_HANDLE, int r_nBindRecord, int r_nBufferType, char* r_pchBuffer, int r_nBufferLength, unsigned long* r_nLength);
AMPS_API int AMPS_DBEngineBindParameters(AMPS_HANDLE r_hAMPS_HANDLE, AMPS_DBE_HANDLE r_phAMPS_DBE_HANDLE, AMPS_DBES_HANDLE r_hAMPS_DBES_HANDLE, void* r_pvBind);
AMPS_API int AMPS_DBEngineExecute(AMPS_HANDLE r_hAMPS_HANDLE, AMPS_DBE_HANDLE r_phAMPS_DBE_HANDLE, AMPS_DBES_HANDLE r_hAMPS_DBES_HANDLE);
AMPS_API int AMPS_DBEngineStatementClose(AMPS_HANDLE r_hAMPS_HANDLE, AMPS_DBE_HANDLE r_phAMPS_DBE_HANDLE, AMPS_DBES_HANDLE r_hAMPS_DBES_HANDLE);
#endif
...
AMPS_API AMPS_IOAGENTS_HANDLE AMPS_IOAgentsInitEx(AMPS_HANDLE r_hAMPS_HANDLE, int r_nNoOfIOAgents, int r_nNoOfInputPipes, AMPS_IOAgentsDispatcherCallback r_pfAMPS_IOAgentsDispatcherCallback, AMPS_IOAgentsInitCallback r_pfAMPS_IOAgentsInitCallback, AMPS_IOAgentsCleanupCallback r_pfAMPS_IOAgentsCleanupCallback, void* r_pvUserData);
